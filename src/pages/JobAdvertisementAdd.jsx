...
import { Button, Container, Grid, Form, Label, Modal, Segment, Header, Icon } from 'semantic-ui-react'
...
export default function JobAdvertisementAdd() {
    ...
    const validationSchema = Yup.object({
        ...
        amount: Yup.number().required("Zorunlu Alan").min(1, "Geçersiz girdi"),
                            ...
                            <Formik>
                                <Form onSubmit={formik.handleSubmit}>
                                    ...
                                    <Form.Group widths="three">
                                        ...
                                        />
                                        {
                                            ...
                                            <div style={{ marginTop: "4%" }}>
                                                <Label basic pointing="left" color='red' content={formik.errors.amount} />
                                            </div>
                                        }
                                    </Form.Group>
                                    ...
                                    />
                                    {
                                        ...
                                        <div >
                                            <Label basic pointing="above" color='red' content={formik.errors.description} />
                                        </div>
                                    }
                                    <Button type="submit" color="orange">Ekle</Button>
